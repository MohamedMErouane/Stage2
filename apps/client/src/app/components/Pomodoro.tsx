...
const PomodoroApp = () => {
  const [sessionLength, setSessionLength] = useState(0); // Updated to start from 0
          ...
          <div className="flex justify-around items-center mb-2">
            <div>
              ...
              <div className="flex justify-center items-center">
                ...
                <button onClick={() => setSessionLength(Math.max(0, sessionLength - 1))} className="p-1 border rounded-full text-white" disabled={sessionLength === 0}><FaMinus /></button>
              </div>
            </div>
            <div>
